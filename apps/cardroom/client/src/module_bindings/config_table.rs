...
/// Lifetime-aware accessor marker for the table `config`.
pub struct ConfigTableAccessor;

impl __sdk::TableAccessor<super::RemoteTables> for ConfigTableAccessor {
    type Row = Config;
    type Handle<'db> = ConfigTableHandle<'db>;
...
impl<'ctx> __sdk::TableLike for ConfigTableHandle<'ctx> {
    type Row = Config;
...
impl<'ctx> __sdk::WithInsert for ConfigTableHandle<'ctx> {
    type InsertCallbackId = ConfigInsertCallbackId;
...
impl<'ctx> __sdk::WithDelete for ConfigTableHandle<'ctx> {
    type DeleteCallbackId = ConfigDeleteCallbackId;
...
impl<'ctx> __sdk::WithUpdate for ConfigTableHandle<'ctx> {
    type UpdateCallbackId = ConfigUpdateCallbackId;
